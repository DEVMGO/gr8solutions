...
// images
import Img from "@/public/assets/images/telefoni/telefoni1.png";
      ...
      <div className="lg:w-1/2 w-full h-auto flex items-start justify-between flex-col 3xl:gap-0 gap-12">
        <div className="flex items-start justify-start flex-col">
          ...
          <p className="max-w-[40rem] 3xl:text-2xl text-lg font-light text-gray80 3xl:mb-12 mb-6">
            Företagstelefoni är en avgörande del av varje verksamhet och vi på
            GR8 Solutions erbjuder ett brett utbud av tjänster för att hjälpa
            dig att hålla kontakten med dina kunder och samarbeta med dina
            medarbetare.
          </p>
        </div>
